 ...
 *
 *  IBM Mobile Cloud Services JavaScript SDK, v1.0.0
 *
 */
...
var IBMHttpRequest = undefined;
  ...
  IBMBluemixConfig.prototype = {
    ...
    _parseApplicationRoute: function () {
      var actualApplicationRoute = this._removeSlashes(this.applicationRoute);
        ...
        if (!appName) {
          ...
          if (mainModule) {
            ...
            if (fs.existsSync(manifestFilePath)) {
              var manifest = yamljs.load(fs.readFileSync(manifestFilePath));
  ...
  var IBMBluemix = _.extend({}, _IBMBluemix, {
      _init: function (config) {
        ...
        try {
          ...
          logger.error(e);
          defer.reject("Invalid config has been passed to the initializeSDK method");
        }
