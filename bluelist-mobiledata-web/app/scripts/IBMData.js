 ...
 *
 *  IBM Backend as a Service JavaScript SDK, 
 *  IBMData Service SDK v0.0.2
 *
 */

 ;
// Generated by IBMData SDK v0.6.13-01 - template: 'combined' 
...
var bundleFactory = function(IBMBaaS) {/**
...
define('clazz',[],function () {
  if (__isNode) {
  return __nodeRequire('clazz');
} else {
  throw new Error("IBMData SDK: trying to access unbound / excluded 'node-only' dependency 'clazz') on browser");
}
});
define('ibm/baas/IBMBaaS', ['require','exports','module'],function (require, exports, module) {
  

var ibmbaas = null;
  var __isAMD = !!(typeof define === "function" && define.amd), __isNode = typeof exports === "object", __isWeb = !__isNode;
  if (!__isNode) {
    if (__isAMD && window["IBMBaaS"]) {
      ibmbaas = IBMBaaS;
    } else {
      clazz = "ibm/baas/IBMBaaS";
      ibmbaas = require(clazz);
    }
  } else {
    if (IBMBaaS) {
      ibmbaas = IBMBaaS;
...
define('IBMBaaS',[],function () {
  if (__isNode) {
  return __nodeRequire('IBMBaaS');
} else {
  return (typeof IBMBaaS !== 'undefined') ? IBMBaaS : __nodeRequire('IBMBaaS')
}
});
...
define('ibm/baas/service/data/error/IBMError', ['require', 'exports', 'module', 'IBMBaaS', '../../../utils'], function (require, exports, module, IBMBaaS, utils) {
...
define('ibm/baas/service/data/error/IBMDataError', ['require', 'exports', 'module', 'IBMBaaS', './IBMError'], function (require, exports, module, IBMBaaS, IBMError) {
...
define('ibm/baas/service/data/comm/_DataServiceRequest', ['require', 'exports', 'module', 'IBMBaaS', '../error/IBMError'], function (require, exports, module, IBMBaaS, IBMError) {
...
define('ibm/baas/service/data/IBMObject', ['require', 'exports', 'module', 'IBMBaaS', '../../utils', './error/IBMDataError', './comm/_DataServiceRequest'], function (require, exports, module, IBMBaaS, utils, IBMDataError, _DataServiceRequest) {
...
var TAG = "IBMObject", OP = _DataServiceRequest.OP;
  ...
  IBMObject.prototype = {
    ...
    read: function () {
      if (!this.getId()) {
        return Q.reject(invalidOperation(OP.READ, "Object must have id.", this.isDeleted()));
      }
...
define('ibm/baas/service/data/IBMQuery', ['require', 'exports', 'module', 'IBMBaaS', './IBMObject', '../../utils', './error/IBMDataError', './comm/_DataServiceRequest'], function (require, exports, module, IBMBaaS, IBMObject, utils, IBMDataError, _DataServiceRequest) {
...
define('ibm/baas/service/data/comm/RestRequest', ['require', 'exports', 'module', 'IBMBaaS', '../../../utils', './_DataServiceRequest', '../error/IBMError'], function (require, exports, module, IBMBaaS, utils, _DataServiceRequest, IBMError) {
...
var TAG = "RestRequest", timeout = 5000;
  ...
  function RestRequest(serviceUrl, appId) {
    ...
    this.restUrl = this.serviceUrl + "/rest/v1/apps/" + appId + "/";
    this.bjax = new IBMXhr();
  }
  utils.inherit(_DataServiceRequest, RestRequest, {
    ...
    _onRequestDone: function (defer, isError) {
      ...
      ;
      function onError(xhrObj, status, error) {
        defer.reject(new RestRequestError("Unexpected error when communicating with server", status, error));
      }
    ...
    _request: function (request) {
      ...
      var xhrOptions = {
          ...
          type: request.method,
          timeout: timeout,
          success: this._onRequestDone(defer).bind(this),
          error: this._onRequestDone(defer, true).bind(this)
        };
      if (request.payload) {
...
define('ibm/baas/service/IBMFileSync', ['require', 'exports', 'module', '../IBMBaaS', './data/IBMObject', './data/IBMQuery', './data/comm/_DataServiceRequest', './data/comm/RestRequest'], function (require, exports, module, IBMBaaS, IBMObject, IBMQuery, _DataServiceRequest, RestRequest) {
  

var bjax = new IBMXhr();
  var IBMFileSync = {
      init: function () {
        var defer = Q.defer(), appId = IBMBaaS.getApplicationId(), serviceUrl = IBMBaaS.getBaaSURL();
        var xhrOptions = {
            url: "http://localhost:3002/mbaas/filesync/v1/apps/d3113f3b-9957-462b-8d2b-07c997ed7eee/connect",
            type: "POST",
            timeout: 5000,
            success: function () {
              console.log("FileSync Success: %o", arguments);
              defer.resolve(arguments);
            },
            error: function () {
              console.error("FileSync Error: %o", arguments);
              defer.reject(arguments);
            },
            headers: {
              "storagetype": "IBMCloud",
              "Client-Id": "com.ibm.cloud",
              "Client-SDK-Version": "v0.2.0.20140402",
              "Client-Platform-Type": "JavaScript Baby!",
              "userid": "mahuffma@us.ibm.com",
              "appid": "d3113f3b-9957-462b-8d2b-07c997ed7eee",
              "params": JSON.stringify({ userid: "mahuffma@us.ibm.com" })
            }
          };
        bjax.xhr(xhrOptions);
        return defer.promise;
...
define('ibm/baas/service/IBMData', ['require', 'exports', 'module', '../IBMBaaS', './IBMFileSync', './data/IBMObject', './data/IBMQuery', './data/comm/_DataServiceRequest', './data/comm/RestRequest'], function (require, exports, module, IBMBaaS, IBMFileSync, IBMObject, IBMQuery, _DataServiceRequest, RestRequest) {
  var __umodule__ = (function (require, exports, module, IBMBaaS, IBMFileSync, IBMObject, IBMQuery, _DataServiceRequest, RestRequest) {
...
var IBMData = {
      ...
      initializeService: function () {
        if (!IBMBaaS) {
          throw new Error("IBMBaaS is undefined.");
        }
        var endpoint = IBMBaaS.getBaaSURL() + "/data", appId = IBMBaaS.getApplicationId();
        var rr = new RestRequest(endpoint, appId);
...
}).call(this, require, exports, module, IBMBaaS, IBMFileSync, IBMObject, IBMQuery, _DataServiceRequest, RestRequest);
...
if (__isAMD) {
  return define(['IBMBaaS'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('IBMBaaS'));
    } else {
        return bundleFactory((typeof IBMBaaS !== 'undefined') ? IBMBaaS : void 0);
    }
}
